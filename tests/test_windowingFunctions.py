...
def test_cosineWings(lengthSupport: int, ratioTaper: float, rtol: float, atol: float, expected: WindowingFunction) -> None:
...
def test_equalPower(lengthSupport: int, ratioTaper: float, rtol: float, atol: float, expected: WindowingFunction) -> None:
...
def test_halfsine(lengthSupport: int, rtol: float, atol: float, expected: WindowingFunction) -> None:
...
def test_tukey(lengthSupport: int, ratioTaper: float, keywordArguments: dict[str, float], rtol: float, atol: float, expected: WindowingFunction) -> None:
